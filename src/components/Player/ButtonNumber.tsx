...
export default function ButtonNumber({ handleClickButton, handleIsSelectedNumber, value, idBoard, selectedNumbers }: ButtonNumberProps) {
    ...
    return (
        <button
            className={`sm:text-2xl text-xl font-bold sm:w-16 sm:h-16 w-12 h-12 border-none rounded-lg text-white hover:bg-cyan-700 active:bg-cyan-600 ${numberSelected === true ? "bg-cyan-500" : "bg-gray-500"}`}
